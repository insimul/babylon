// Re-export shim — moved to @insimul/core (packages/core/src/game-engine/logic/GameTruthSync).
...
// Kept so `@shared/game-engine/logic/GameTruthSync` (platform @shared aliases, the shared/
// shim chain, and the export-pipeline vendoring) keeps resolving unchanged.
export * from '@insimul/core/game-engine/logic/GameTruthSync';
