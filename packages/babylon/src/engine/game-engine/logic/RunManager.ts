// Re-export shim — moved to @insimul/core (packages/core/src/game-engine/logic/RunManager).
...
// Kept so `@shared/game-engine/logic/RunManager` (platform @shared aliases, the shared/
// shim chain, and the export-pipeline vendoring) keeps resolving unchanged.
export * from '@insimul/core/game-engine/logic/RunManager';
