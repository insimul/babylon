...
export type { MasteryLevel } from '../../language/mastery';
import type { MasteryLevel } from '../../language/mastery';
export { MASTERY_LEVELS } from '../../language/mastery';
/** Thresholds for advancing mastery (correct uses required). Canonical source: ../../language/mastery */
import { MASTERY_THRESHOLDS as _CANONICAL_THRESHOLDS } from '../../language/mastery';
